 ...
 * |--------+------+------+------+------+------| Hyper|           | Meh  |------+------+------+------+------+--------|
 * |LGui/Hen|Z/Ctrl|X/Alt |   C  |   V  |   B  |      |           |      |   N  |   M  |   ,  |./Alt |//Ctrl|Shift/MH|
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |Grv/L1|  '"  |AltShf| LGui | LAlt |                                       | RAlt | RGui |   [  |   ]  | ~L1  |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        | LEFT | RGHT |       | DOWN |  UP  |
 *                                 ,------|------|------|       |------+--------+------.
...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        ...
        LGUI_T(KC_HENK),        LCTL_T(KC_Z), LALT_T(KC_X),   KC_C,   KC_V,   KC_B,   ALL_T(KC_NO),
        LT(SYMB,KC_GRV),        TG(DVRK),     LALT(KC_LSFT),  KC_LEFT,KC_RGHT,
                                              KC_LEFT, KC_RGHT,
                                                       KC_HOME,
        ...
        // right hand
             ...
             MEH_T(KC_NO),KC_N,   KC_M,  KC_COMM,RALT_T(KC_DOT), CTL_T(KC_SLSH),   RSFT_T(KC_MHEN),
