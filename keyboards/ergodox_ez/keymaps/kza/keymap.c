 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |  L3  |  L0  |AltTab| LAlt | LGui |                                       |   -  |   =  |  Grv  |  L2  |  L1  |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        | Home | End  |       | LEFT | RGHT |
 *                                 ,------|------|------|       |------+--------+------.
...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        ...
        TO(GAME),               TO(BASE),             LALT(KC_TAB),   KC_LALT, KC_LGUI,
                                                      KC_HOME, KC_END,
                                                      KC_PGUP,
 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |Grv/L1|  L0  |AltShf| LGui | LAlt |                                       | LEFT | DOWN |  UP  |RIGHT | ~L1  |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        | App  | RGHT |       | DOWN |  UP  |
 *                                 ,------|------|------|       |------+--------+------.
...
[GAME] = LAYOUT_ergodox(  // layer 3 : game
        ...
        LT(SYMB,KC_GRV),        TO(BASE),     LALT(KC_TAB),   KC_LGUI, KC_LALT,
                                              KC_APP, KC_LGUI,
                                                       KC_HOME,
